namespace rado_blog.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<rado_blog.Models.ApplicationDbContext>
{
        ...
        string title, string body, DateTime date, string authorUsername)
    {
        ...
        post.Body = body;
        post.Date = date;
        post.Autor = context.Users.Where(u => u.UserName == authorUsername).FirstOrDefault();
